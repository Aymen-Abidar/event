import { AlertCircle, CalendarDays, CheckCircle2, MapPin, Trash2 } from "lucide-react";
...
const errorMessages: Record<string, string> = {
  invalid: "Réservation non enregistrée: vérifiez client, matériel, quantité, prix et dates.",
  dates: "Réservation non enregistrée: la date de retour doit être après la livraison, et la date événement ne doit pas être avant la livraison.",
  stock: "Réservation non enregistrée: stock insuffisant pour cette période.",
  create: "Réservation non enregistrée: erreur base de données. Vérifiez Supabase ou les logs.",
  forbidden: "Action refusée: votre compte n’a pas l’autorisation."
};
    ...
    <div className="space-y-6">
      ...
      {params.error ? (
        <div className="flex items-center gap-3 rounded-2xl border border-red-200 bg-red-50 px-4 py-3 text-sm font-semibold text-red-700">
          ...
          {errorMessages[params.error] || "Réservation non enregistrée: erreur inconnue."}
        </div>
      ) : null}
